...
(function() {
  var City, Cluster, Model, normalDistribution, rand,
  ...
  normalDistribution = (function(_this) {
  ...
  City = (function(_super) {
    ...
    function City() {
      this.stationAt = __bind(this.stationAt, this);
      this.addStation = __bind(this.addStation, this);
      ...
      var cluster, row, x, y, _i, _j, _k, _ref, _ref1, _ref2;
      ...
      for (x = _j = 0, _ref1 = this.size[0] - 1; 0 <= _ref1 ? _j <= _ref1 : _j >= _ref1; x = 0 <= _ref1 ? ++_j : --_j) {
        ...
        for (y = _k = 0, _ref2 = this.size[1] - 1; 0 <= _ref2 ? _k <= _ref2 : _k >= _ref2; y = 0 <= _ref2 ? ++_k : --_k) {
          cluster = new Cluster([]);
    ...
    City.prototype.distribute = function() {
      ...
      centers = [];
      padding = 0.0015 * this.size[0] * this.size[1];
      ...
      addPeople = (function(_this) {
        return function(i, nx, ny) {
          var cluster, density, mean, number, stddev;
    ...
    City.prototype.addStation = function(station) {
      if (this.stationsGrid[station.index[0]][station.index[1]]) {
        return;
      }
      this.stationsGrid[station.index[0]][station.index[1]] = station;
      this.stations.push(station);
      return this.trigger('city.station.added', station);
    };

    City.prototype.stationAt = function(_arg) {
      var x, y;
      x = _arg[0], y = _arg[1];
      return this.stationsGrid[x][y];
    };
