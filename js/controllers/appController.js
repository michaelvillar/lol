...
(function() {
  var AREA_RADIUS, AppController, City, TILE_HEIGHT, TILE_WIDTH, Window, elementPos,
  ...
  AppController = (function() {
    ...
    function AppController(el) {
      ...
      this.areaElement.style.width = TILE_WIDTH * AREA_RADIUS * 2 + "px";
      this.areaElement.style.height = TILE_HEIGHT * AREA_RADIUS * 2 + "px";
    ...
    AppController.prototype.updateWindow = function(tile) {
      var content, index, pos;
      pos = elementPos(tile);
      this.areaElement.style.left = pos[0] + (TILE_WIDTH / 2) - (AREA_RADIUS * TILE_WIDTH) + "px";
      this.areaElement.style.top = pos[1] + (TILE_HEIGHT / 2) - (AREA_RADIUS * TILE_HEIGHT) + "px";
